...
var author$project$Main$make_screen = function (_n0) {
	var height = _n0.height;
	var width = _n0.width;
	return {
		height: height,
		orientation: (_Utils_cmp(height, width) > 0) ? author$project$Main$Portrait : author$project$Main$Landscape,
		width: width
	};
};
...
var author$project$Style$modern_serif = mdgriffith$elm_ui$Element$Font$external(
	{name: 'Computer Modern Serif', url: '//cdn.rawgit.com/dreampulse/computer-modern-web-font/master/font/Serif/cmun-serif.css'});
...
var author$project$Style$font_family = mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[author$project$Style$modern_serif, mdgriffith$elm_ui$Element$Font$serif]));
var author$project$Style$base_size = 32;
...
var author$project$Style$font_size = mdgriffith$elm_ui$Element$Font$size(author$project$Style$base_size);
...
var author$project$Main$lit = function (str) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[author$project$Style$font_family, author$project$Style$font_size]),
...
var author$project$Main$sym = function (str) {
	return A2(
		mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[author$project$Style$font_family, author$project$Style$font_size, mdgriffith$elm_ui$Element$Font$italic]),
		mdgriffith$elm_ui$Element$text(str));
};
...
var author$project$Style$spacing = mdgriffith$elm_ui$Element$spacing((author$project$Style$base_size / 3) | 0);
...
var author$project$Main$line1 = A2(
	mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[author$project$Style$spacing]),
	_List_fromArray(
		[
			author$project$Main$sym('n'),
			author$project$Main$lit('='),
			author$project$Main$lit('2')
		]));
...
var author$project$Main$space_right = F2(
	function (space, el) {
		return A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					...
					{bottom: 0, left: 0, right: space, top: 0})
				]),
			el);
	});
var author$project$Main$fn = F2(
	function (name, arg) {
		return A2(
			mdgriffith$elm_ui$Element$row,
			_List_Nil,
			_List_fromArray(
				[
					A2(
					author$project$Main$space_right,
					(author$project$Style$base_size / 4) | 0,
					author$project$Main$sym(name)),
					author$project$Main$lit('('),
					A2(
					author$project$Main$space_right,
					(author$project$Style$base_size / 16) | 0,
					author$project$Main$sym(arg)),
					author$project$Main$lit(')')
				]));
	});
var author$project$Main$line2 = A2(
	mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[author$project$Style$spacing]),
	_List_fromArray(
		[
			A2(author$project$Main$fn, 'f', 'x'),
			author$project$Main$lit('='),
			author$project$Main$sym('x'),
			author$project$Main$lit('+'),
			author$project$Main$lit('1')
		]));
var author$project$Main$line3 = A2(author$project$Main$fn, 'f', 'n');
...
var author$project$Main$slide1 = A2(
	mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
	...
	A2(
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$spacing(author$project$Style$base_size)
			]),
		_List_fromArray(
			[author$project$Main$line1, author$project$Main$line2, author$project$Main$line3])));
var author$project$Main$slides = _List_fromArray(
	[
		author$project$Main$slide1,
		mdgriffith$elm_ui$Element$text('Slide 2')
	]);
var author$project$Main$slides_quantity = elm$core$List$length(author$project$Main$slides);
...
var author$project$Main$slide_no_from_url = function (url) {
	var fragment = A2(
		elm$core$Maybe$withDefault,
		1,
		A2(elm$core$Maybe$andThen, elm$core$String$toInt, url.fragment));
	return (fragment < 1) ? 1 : ((_Utils_cmp(fragment, author$project$Main$slides_quantity) > 0) ? author$project$Main$slides_quantity : fragment);
};
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Main$init = F3(
	function (flags, url, nav) {
		var slide_no = author$project$Main$slide_no_from_url(url);
		var screen = author$project$Main$make_screen(
			{height: 240, width: 320});
		return _Utils_Tuple2(
			{screen: screen, slide_no: slide_no},
		...
		switch (message.$) {
			...
			case 'SetUrl':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			default:
				var height = message.a.height;
				var width = message.a.width;
				var screen = author$project$Main$make_screen(
					{height: height, width: width});
				return _Utils_Tuple2(
					_Utils_update(
...
var author$project$Main$render = function (state) {
	var maybe_slide = A2(
		elm$core$Array$get,
		state.slide_no - 1,
		elm$core$Array$fromList(author$project$Main$slides));
	if (maybe_slide.$ === 'Just') {
		var slide = maybe_slide.a;
		return slide;
	} else {
...
var author$project$Style$font_attrs = _List_fromArray(
	[
		mdgriffith$elm_ui$Element$Font$size(author$project$Style$base_size),
...
var author$project$Main$view = function (state) {
	var html = A2(
		...
		author$project$Style$font_attrs,
		author$project$Main$render(state));
	return {
...
var author$project$Main$main = elm$browser$Browser$application(
	{
		...
		onUrlChange: author$project$Main$SetUrl,
		onUrlRequest: elm$core$Basics$always(author$project$Main$None),
